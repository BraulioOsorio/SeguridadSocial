...
|
*/
$config['base_url'] = 'http://[::1]/app-social-security/';
...
$config['sess_expiration'] = 86400; // tiempo de expiracion de la sesion 2 horas (7200)
$config['sess_save_path'] = NULL;
$config['sess_match_ip'] = FALSE;
$config['sess_time_to_update'] = 300;
$config['sess_regenerate_destroy'] = FALSE;
$config['sess_expire_on_close'] = TRUE; // La cookie de sesión expirará al cerrar el navegador.
